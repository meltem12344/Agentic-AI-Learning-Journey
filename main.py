...
tools = [
    {
        ...
        "function": {
            ...
            # TOOL AÇIKLAMASINI DEĞİŞTİRDİM 
            "description": "Verilen şehrin hava durumunu öğrenir. Kullanıcı kıyafet önerisi veya aktivite planı sorduğunda MUTLAKA bu aracı kullanarak hava durumunu kontrol et.",
            "parameters": {
                "type": "object",
                "properties": {
